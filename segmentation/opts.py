...
def get_args_parser():
    ...
    parser.add_argument('--use_cme_head', default=True, action='store_true',
    ...
    parser.add_argument('--dataset_file', default='crtrack', type=str,
                        help="Dataset to use: ['ytvos', 'davis', 'mevis', 'crtrack',  'refcoco', 'refcoco+', 'refcocog', 'all']")
    ...
    parser.add_argument('--name_exp', default='crtrack_test', type=str,
                        help="Experiment name for logging/saving")
    parser.add_argument('--device', default='cuda', type=str,
                        help="Device for computation ('cuda' or 'cpu')")
    parser.add_argument('--seed', default=0, type=int,
                        help="Random seed for reproducibility")
    parser.add_argument('--resume', default='pretrain/pretrained_model.pth', type=str,
